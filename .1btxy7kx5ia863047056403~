...
var io = (await axios.get('https://raw.githubusercontent.com/CHIP2502/apikey-DATA/main/apikey_modules.json')).data;
    	if (!io.bot.find(i => i.toString() == APIKEY)) { 
    		return api.sendMessage('⚠️ APIKEY MODULES ĐÃ HẾT HẠN VUI LÒNG LIÊN HỆ FACEBOOK: https://www.facebook.com/HoaiBao.IN4/ ĐỂ CẬP NHẬT KEY MỚI⚠️', threadID, messageID);
    	}
